...
public class InstanceDaoImpl implements InstanceDao {
    ...
    public List<Instance> getExpiredInstances() {
        ...
        return entityManager.createQuery( //
                "FROM Instance ice " +
                "WHERE ice.nextUpdate <= :currentTime OR ice.nextUpdate = null", Instance.class)
    ...
    public void createOrUpdate(final Instance instance) {
        ...
        if (instance.getId() == null) {
            ...
            instance.setNextUpdate(new Date());
            ...
            if (instance.getNextUpdate() != null) {
                editInstance.setNextUpdate(instance.getNextUpdate());
            }
    ...
    public List<Instance> getInstancesForPrefixes(String projectPrefix, String environmentPrefix) {
        ...
        return  entityManager.createQuery( //
                "FROM Instance ice " +
                "WHERE ice.projectEnvironment.environment.name LIKE :environmentPrefix " +
                ...
                .setParameter("environmentPrefix", StringUtils.join(new Object[] {environmentPrefix, "%"}))
                .setHint("org.hibernate.cacheable", true)
                .getResultList();
        //@formatter:on;
    }
    ...
    public List<Instance> getInstancesForProjectEnvironment(Long projectEnvironmentId) {
        ...
        return  entityManager.createQuery( //
                "FROM Instance ice " +
                "WHERE ice.projectEnvironment.id = :projectEnvironmentId ",  Instance.class)
                .setParameter("projectEnvironmentId", projectEnvironmentId)
                .setHint("org.hibernate.cacheable", true)
                .getResultList();
        //@formatter:on
    }
